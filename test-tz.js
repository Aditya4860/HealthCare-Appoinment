...
function runTests() {
    ...
    console.log(`Current IST Display: ${(0, timezone_1.formatIST)(now, "yyyy-MM-dd hh:mm:ss a 'IST'")}`);
    // Test 1: Future slot
    // Pick tomorrow
    const tmrw = new Date(now.getTime() + 86400000);
    const tmrwDateStr = (0, timezone_1.formatIST)(tmrw, "yyyy-MM-dd");
    const isPastTmrw = (0, timezone_1.isSlotInPastIST)(tmrwDateStr, "10:00");
    ...
    const todayStr = (0, timezone_1.formatIST)(oneMinAgo, "yyyy-MM-dd");
    const pastTimeStr = (0, timezone_1.formatIST)(oneMinAgo, "HH:mm");
    const isPastToday = (0, timezone_1.isSlotInPastIST)(todayStr, pastTimeStr);
    ...
    const todayStr2 = (0, timezone_1.formatIST)(oneHrFuture, "yyyy-MM-dd");
    const futureTimeStr = (0, timezone_1.formatIST)(oneHrFuture, "HH:mm");
    const isPastTodayFuture = (0, timezone_1.isSlotInPastIST)(todayStr2, futureTimeStr);
    ...
    const parsed = (0, timezone_1.parseISTToUTC)("2026-08-25", "10:00");
    ...
    console.log(`Formatted back to IST: ${(0, timezone_1.formatIST)(parsed, "yyyy-MM-dd hh:mm a")}`);
}
runTests();
